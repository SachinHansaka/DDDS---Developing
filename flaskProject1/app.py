...
def start_detection():
    ...
    while (True):
        ...
        for face in faces:
            ...
            if (eye_counter or yawn_counter) > 500:
                cv2.putText(frame, "Take a break", (150, 200), cv2.FONT_HERSHEY_SIMPLEX, 1.5, (0, 0, 255), 2)
...
def start_stop():
    if request.form['submit_button'] == 'Start':
        # Call your drowsiness detection function here
        start_detection()
    elif request.form['submit_button'] == 'Stop':
        # Call your stop detection function her
        stop_detection()
    return render_template('new2.html')
